    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability', models.CharField(choices=[('available', 'Available'), ('busy', 'Busy'), ('offline', 'Offline')], default='offline', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookmarks', models.ManyToManyField(blank=True, related_name='bookmarked_by', to='accounts.freelancerprofile')),
            ],
        ),
    ]
